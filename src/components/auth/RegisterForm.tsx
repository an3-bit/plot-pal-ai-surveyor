...
import { Eye, EyeOff, Mail, Lock, User, Building, Layers } from "lucide-react";
      ...
      <Card className="w-full max-w-md shadow-strong">
        <CardHeader className="text-center space-y-4">
          ...
          <div>
            ...
            <CardDescription>
              Join SurveyPro and start revolutionizing your land surveying practice
            </CardDescription>
          </div>
        </CardHeader>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  id="organization"
                  type="text"
                  placeholder="Your Survey Company"
